<div id="tm-offcanvas" class="uk-offcanvas">
     <div class="uk-offcanvas-bar">
          <ul class="uk-nav uk-nav-offcanvas uk-nav-parent-icon" data-uk-nav="{ multiple: true }">
                        ...
                        <ul class="uk-nav-sub">
                            ...
                            <nav class="tm-navbar uk-navbar uk-navbar-attached uk-navbar-transparent">
                                <div class="uk-container uk-container-center">
                                    ...
                                    <a class="uk-navbar-brand uk-hidden-small" href="index.html"><img class="uk-margin uk-margin-remove" src="../assets/img/logo.png" width="100" height="36" title="UIkit" alt="UIkit"></a>
                                    ...
                                    <div class="uk-navbar-brand uk-navbar-center uk-visible-small"><img src="../assets/img/logo.png" width="100" height="36" title="UIkit Vue Wordpress" alt="UIkit Vue Wordpress"></div>
                    ...
                    <li class="uk-parent"><a href="#"><i class="uk-icon-wrench"></i> Main Menu</a>
                        <ul class="uk-nav-sub">
                    ...
                    <li class="uk-parent"><a href="#"><i class="uk-icon-th-large"></i></a>
                        <ul class="uk-nav-sub">
