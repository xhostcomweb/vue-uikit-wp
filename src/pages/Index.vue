<template>
  ...
  <div class="tm-section tm-section-color-1 tm-section-colored">
            <div class="uk-container uk-container-center uk-text-center">
                ...
                <img class="tm-logo" src="../assets/img/logo_large.png" width="281" height="217" title="UIkit Vue Wordpress" alt="UIkit Vue Wordpress">

                <p class="uk-text-large">A lightweight and modular front-end framework<br class="uk-hidden-small"> for developing fast and powerful web interfaces. Vue JS version with a Wordpress Rest API CMS.</p>
  ...
  <div class="tm-section tm-section-color-2 tm-section-colored">
            <div class="uk-container uk-container-center uk-text-center">
                ...
                <p class="uk-text-large">UIkit Vue WP is built using UIKiT, Vue JS & Wordpress, & gives you a comprehensive collection of HTML, CSS, and JS components<br class="uk-hidden-small"> which is simple to use, customizable and extendable.</p>

                <div class="uk-grid" data-uk-grid-margin>

                    <div class="uk-width-medium-1-4">
                        <div class="uk-panel">
                            <img class="tm-image-pull" src="../assets/img/icon_less.svg" width="200" height="140" alt="LESS">
                    ...
                    <div class="uk-width-medium-1-4">
                        <div class="uk-panel">
                            <img class="tm-image-pull" src="../assets/img/icon_components.svg" width="200" height="140" alt="Components">
                    ...
                    <div class="uk-width-medium-1-4">
                        <div class="uk-panel">
                            <img class="tm-image-pull" src="../assets/img/icon_themes.svg" width="200" height="140" alt="Themes">
                    ...
                    <div class="uk-width-medium-1-4">
                        <div class="uk-panel">
                            <img class="tm-image-pull" src="../assets/img/icon_responsive.svg" width="200" height="140" alt="Responsive">
                ...
                <div class="uk-grid tm-grid-margin-large" data-uk-grid-match="{target:'.uk-panel'}" data-uk-grid-margin>
                    ...
                    <div class="uk-width-medium-1-3">
                        <a class="uk-panel tm-panel-link" href="https://plus.google.com/communities/114238665434626719878">
                            ...
                            <p>If you're interested in discussing, participating and helping each other, the UIkit Facebook community is the place to be.</p>
                        </a>
                    </div>
        ...
        <div class="tm-section tm-section-color-2 tm-section-colored">
            <div class="uk-container uk-container-center uk-text-center">
                ...
                <p class="uk-text-large">UIkit Vue Wordpress is open source to make building stuff easier.<br class="uk-hidden-small"> Using UIKit, Vue JS and Wordpress Rest API for back end.</p>
                ...
                <div class="uk-grid uk-grid-divider" data-uk-grid-margin>
                    ...
                    <div class="uk-width-1-1 uk-width-medium-1-3">
                        <div class="uk-panel">
                            <h2>MIT License</h2>
                            <p>UIkit Vue Wordpress is absolutely free of charge and you can use, copy, merge, publish and distribute the framework without any limitations.</p>
                        </div>
                    </div>
                    ...
                    <div class="uk-width-medium-1-3">
                        <div class="uk-panel">
                            <h2>Our Heros</h2>
                            <p>A big thanks to LESS, jQuery, UIKit, Vue JS and Wordpress. It wouldn't be possible without these awesome open source projects.</p>
                        </div>
                    </div>
                    ...
                    <div class="uk-width-medium-1-3">
                        <div class="uk-panel">
                            ...
                            <p>UIkit Vue Wordpress is built by <a href="http://www.xhoscom.com">Xhostcom</a>, using our extensive experience in Vue JS and Wordpress, to power the <a href="#">UIKit Vue Wordpress Project</a>.</p>
                        </div>
                    </div>
...
export default {
      head () {
        return {
          title: `Gridsome UIKit Wordpress`,
          metaInfo: [
            {
              hid: 'description',
              name: 'description',
              content: 'Gridsome UIKit - A front-end wordpress SEO friendly in vue.js'
            },
            {
              property: 'og:title',
              content: 'Gridsome UIKit'
            },
            {
